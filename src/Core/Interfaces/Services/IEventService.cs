...
namespace Core.Interfaces.Services
{
    public interface IEventService
    {
        ...
        Task<IDataResult<IEnumerable<ViewEventDto>>> GetEventListByDateRangeAsync(Guid userId, DateTimeOffset startDate, DateTimeOffset endDate, CancellationToken cancellationToken)
